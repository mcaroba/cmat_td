...
plot "NVTP.dat" u 3:(-(column(4)-8.617e-5*column(1)/column(2)*column(3))/8.617e-5/(column(1)/column(2))**2/column(3) * 1.e-24 * 6.022e23):(column(1)/column(2)*1000.) t "Calculated (MD)" pt 7 lw 4 lc palette, \
     "optim.dat" u 1:2 w lp t "Experimental" lw 4, \
     "NVTP.dat" u 3:(-(column(4)-8.617e-5*column(1)/column(2)*column(3))/8.617e-5/(column(1)/column(2))**2/column(3) * 1.e-24 * 6.022e23):5 w labels left not
eof
